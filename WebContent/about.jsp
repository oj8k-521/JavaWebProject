...
<jsp:include page="header.jsp"></jsp:include>
	<article>
		<div class="whitebg about">
			...
			<span class="ly_button"><a
				href="http://www.yangqq.com/e/tool/gbook/?bid=1" target="_blank">留言</a></span>
			...
			<ul class="myblog">
				<li><b>创建时间</b>
					<p>2011年01月12日</p>
					<p>
						<a href="http://www.yangqq.com" target="_blank" class="buttons">主页</a>
					</p></li>
				<li><b>主题模板</b>
					<p>
						<a href="http://www.yangqq.com" target="_blank">《今夕何夕》</a>
					</p>
					<p>
				...
				<li><b>网站程序</b>
					<p>帝国CMS7.5</p>
					<p>
						<a href="http://www.yangqq.com" target="_blank" class="buttons">下载</a>
					</p></li>
				<li><b>服务器商</b>
